        ...
        <div class="navbar">
            ...
            <ul class="nav">
                ...
                <li class="nav-main-item  menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-28">
                    ...
                    <a class="nav-main-link" href="<?php echo base_url(); ?>" style="font-size: 19px">หน้าแรก</a>
               ...
               <li class="cat-item">
                ...
                <li class="cat-item">
                    ...
                    <a href="<?php echo base_url('/page/categoty/id/28/NetflixMovie'); ?>" title="Asia Movie" style="font-size: 19px">
