...
class Video_Model extends Model
{
    ...
    protected $seo = 'seo';
    public $backURL = "http://backend.varietyphp.com/";
    ...
    public function  get_listyear($branch_id)
    {
        ...
        $sql = "SELECT movie_year FROM `$this->table_movie` WHERE branch_id = '$branch_id' GROUP BY movie_year
    ...
    public function get_list_video_search($keyword = "", $branch_id, $page = 1)
    {
        //   print_r($keyword);
        //    die;
        $sql_where = " ";
    ...
    //   public function get_list_video_search( $keyword="", $branchid)
    //   {
